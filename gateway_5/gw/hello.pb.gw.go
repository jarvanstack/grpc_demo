...
func request_HelloHTTP_SayHello_0(ctx context.Context, marshaler runtime.Marshaler, client extGw.HelloHTTPClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extGw.StringMessage
...
func local_request_HelloHTTP_SayHello_0(ctx context.Context, marshaler runtime.Marshaler, server extGw.HelloHTTPServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extGw.StringMessage
	var metadata runtime.ServerMetadata
...
func RegisterHelloHTTPHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extGw.HelloHTTPServer) error {
	...
	mux.Handle("POST", pattern_HelloHTTP_SayHello_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/gateway.HelloHTTP/SayHello")
		if err != nil {
...
func RegisterHelloHTTPHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterHelloHTTPHandlerClient(ctx, mux, extGw.NewHelloHTTPClient(conn))
}

// RegisterHelloHTTPHandlerClient registers the http handlers for service HelloHTTP
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "extGw.HelloHTTPClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "extGw.HelloHTTPClient"
// doesn't go through the normal gRPC flow (creating a gRPC client etc.) then it will be up to the passed in
// "extGw.HelloHTTPClient" to call the correct interceptors.
func RegisterHelloHTTPHandlerClient(ctx context.Context, mux *runtime.ServeMux, client extGw.HelloHTTPClient) error {

	mux.Handle("POST", pattern_HelloHTTP_SayHello_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/gateway.HelloHTTP/SayHello")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
